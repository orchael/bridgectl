...
func TestDoctorReportsNetworkStatus(t *testing.T) {
	...
	tok := deviceToken{BridgeURL: server.URL, APIVersion: "v1", OrganizationID: "org", InstallationID: "install", TelemetryEndpoint: "https://bridge.example/v1/telemetry/segments", CollectorCredential: "brc_secret"}
